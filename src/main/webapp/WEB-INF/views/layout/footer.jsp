...
<footer class="footer footer-black  footer-white ">
        <div class="container-fluid">
          <div class="row">
            <nav class="footer-nav">
              <ul>
                <li>
                  <a href="<c:url value="https://www.creative-tim.com"/>" target="_blank">Creative Tim</a>
                </li>
                <li>
                  <a href="<c:url value="http://blog.creative-tim.com/"/>" target="_blank">Blog</a>
                </li>
                <li>
                  <a href="<c:url value="https://www.creative-tim.com/license"/>" target="_blank">Licenses</a>
                </li>
              </ul>
            </nav>
  ...
  <script src="<c:url value="/assets/js/paper-dashboard.min.js?v=2.0.0"/>" type="text/javascript"></script>
